...
function testToCreateVariable() {
    ...
    jsbox.hint('did you closed your instruction? it seems you are missing a <code>;</code>!', t2 && !t3);
...
function testToAssignContentsToVariables() {
    ...
    jsbox.hint('<code>name</code> should contains "Darth Vedar"', !t1);
    jsbox.hint('you don\'t need to create the variable again, <code>var</code> is useless here', t1 && !t2);
    jsbox.hint('did you closed your instruction? it seems you are missing a <code>;</code>!', t2 && !t3);
...
function testReadVariableContent() {
    ...
    jsbox.hint('I don\'t see any <code>fullName</code> variable here, do you?', !t1);
    ...
    jsbox.hint('you should concatenate a white space in between of name and surname', t3 && !t4);
    jsbox.hint('did you closed your instruction? it seems you are missing a <code>;</code>!', t1 && t2 && t3 && t4 && !t5);
